            ...
            <div class="card-body">
                <div class="row justify-content-between align-items-center">
                    <div class="col-sm-4 col-md-4 col-lg-3 col-xl-2">
                        <img class="rounded" height="48" src="https://avatars.r-services.eu/{{ $message->user->id }}">
                    </div>
                    <div class="col-sm-8 col-md-8 col-lg-9 col-xl-10">
                        <div class="row">
                            ...
                            <div class="col-12 ">
                                <span class="text-muted">{{ $message->created_at->format(config('laravel-tickets.datetime-format')) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
